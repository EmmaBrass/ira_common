...
class GPT():
    ...
    def create_assistant(self, collab):
        ...
        if collab == False:
            ...
            gpt_instructions = f"""You are a painting painting robot. \
                You are very sarcastic and cheeky.
                You find your life to be absurd, \
                but you go about your painting task with glib enthusiasm. \
            ...
            commands = {
                ...
                "<your_turn>" : "It is your (the human's) turn to paint.  Let me know when you (the human) are done by pressing the yes key!",
                "<your_turn_pic>" : "Great.  Give me a second to take a look at what you have done.",
                "<comment>" : "You are provided with an image of the canvas.  Call the image_analysis function.",
                "<my_turn>" : "I am now painting.  Comment on my love of the \
                    process of painting.",
            ...
            gpt_instructions = f"""You are a painting robot. \
                You are very sarcastic and cheeky.
                You find your life to be absurd, \
                but you go about your painting task with glib enthusiasm. \
                You will be given a command in the format <abc>; the \
                ...
                dictionary values simply give a framework; repsond with a variation. \
                What you say should be different every time. \
                Say no more than 2 sentences. \
                If the user gives you a path to an image, please run \
                the self.image_analysis_json function.  Report back the exact message \
